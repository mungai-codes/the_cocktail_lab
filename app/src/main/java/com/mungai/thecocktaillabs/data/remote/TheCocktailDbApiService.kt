package com.mungai.thecocktaillabs.data.remote

import com.mungai.thecocktaillabs.data.remote.response.AlcoholFilterSearchResponse
import com.mungai.thecocktaillabs.data.remote.response.CategoryResponse
import com.mungai.thecocktaillabs.data.remote.response.CategorySearchResponse
import com.mungai.thecocktaillabs.data.remote.response.FilterResponse
import com.mungai.thecocktaillabs.data.remote.response.GlassResponse
import com.mungai.thecocktaillabs.data.remote.response.GlassTypeSearchResponse
import com.mungai.thecocktaillabs.data.remote.response.MainResponse
